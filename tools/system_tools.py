...
def control_apple_music(command: str, track_name: str = "", playlist_name: str = "") -> str:
    """
    Controls the native Apple Music application on Mac for LOCAL library tracks/playlists.
    Use this for play, pause, next, previous, or playing local tracks/playlists.
    
    :param command: 'play', 'pause', 'next', 'previous', 'play_track', or 'play_playlist'.
